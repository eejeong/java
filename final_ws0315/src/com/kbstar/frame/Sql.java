...
public class Sql {
	...
	// Transaction DML
	public static String TransInsertSql = "INSERT INTO transaction VALUES(SYSDATE, ?, ?, ?, ?)"; // tran_date, acc_no, balance, type, description
	public static String TransSelectSql = "SELECT *  FROM transaction WHERE acc_no=?";
	public static String myTransSelectAllSql = "SELECT *  FROM transaction WHERE acc_holder = ?"; // 내 거래 내역 조회
}
